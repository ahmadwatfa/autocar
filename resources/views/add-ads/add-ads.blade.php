            ...
            <div id="first-car-info" class="col-sm-12">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <a class="category" id="1" href="{{ route('ads-car.create') }}">
                            <span><i class="fa fa-car-side"></i></span>
                            <b>{{ __('messages.car') }}</b>
                        </a>
                    </div>
                    <div class="col-md-6 col-sm-12">
                        <a class="category" id="2" href="{{ route('ads-motorcycle.create') }}">
...
@section('pagescript')
    <script>
        $(document).on('ready', function() {
            // $('#exampleModalCenterEmail').modal('hide');
            // console.log();
            @guest
        ...
        $('#category1').remove(); $('#category2').remove(); $('#category3').remove(); $('#category4').remove(); $(
            '#last-car-info1').hide(); $('#last-car-info2').hide(); $('#last-car-info3').hide(); $(
            '#last-car-info4').hide();
