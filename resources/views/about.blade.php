...
<body>
    ...
    <div class="about-content">
        <div class="container">
            <h5>أوتومارك بيع أو اشتري مركبتك من خلالنا</h5>
            <p>يقدم المعلومات المتوفرة عن أي مركبة مستعملة ويساعد الباحثين عن سيارات مستعملة على اتخاذ قرار الشراء.</p>
            <p>يأتيكم موقع أوتومارك بأحدث عروض السيارات الجديدة والمستعملة من الحراجات ومعارض السيارات المنتشرة في أرجاء
                المملكة العربية السعودية، محدثة يومياً بآخر الأسعار والمواصفات، إلى جانب معلومات الاتصال الخاصة بهذه
                المعارض لتسهيل التواصل مع أصحاب العلاقة بشكل مباشر وبدون وسيط.
            </p>
            <p>إذا كنت أحد أصحاب المعارض الراغبين بعرض سياراتهم على موقعنا، يمكنك التواصل مع فريق خدمة العملاء لدينا على
                الأرقام التالية: ( <b>011527867567</b> ) أو عبر البريد الالكتروني: <b>sales@automark.com</b></p>
