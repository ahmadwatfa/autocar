...
<body>
    ...
    <div class="policy-content">
        <div class="container">
            ...
            <p>
                شركة أوتومارك تحترم خصوصيتك و ملتزمة بحماية البيانات الشخصية الخاصة بك إذا قمت بزيارة موقعنا على
                الإنترنت ، أو شراء أو استخدام أي من منتجاتنا أو خدماتنا ، أو الاتصال بنا ، فإن هذه السياسة تناسبك
            </p>
            <br>
            <h5>جمع المعلومات</h5>
            <p>
                المعلومات المنشورة على موقع أوتو مارك متاحة للجمهور ، إذا اخترت تزويدنا بمعلومات شخصية ، فإنك توافق على
                نقل وتخزين هذه المعلومات على خوادمنا في المملكة المتحدة والإمارات العربية المتحدة. نقوم بجمع وتخزين
                المعلومات الشخصية التالية:
            </p>
            <ul>
                <li>عنوان الإيميل، معلومات الاتصال، وبعض الأحيان (حسب الخدمة المستعملة) المعلومات المالية.</li>
                <li>بيانات تسجيل الدخول على الكمبيوتر، إحصاءات عن عدد مشاهدة الصفحة، حركة المرور من وإلى موقع يللا
                    موتور، والاستجابة للإعلانات.</li>
                <li>معلومات أخرى تتضمن عنوان بروتوكول الانترنت الخاص بالمستخدمين ومعلومات التسجيل القياسية على شبكة
                    الانترنت.</li>
            </ul>
            <br>
            <h5>مع من نشارك معلوماتك الشخصية</h5>
            <p>
                نحن لا نبيع أو نؤجر المعلومات الشخصية للمستخدمين لأطراف ثالثة لأغراض التسويق الخاصة بهم دون موافقة صريحة
                من المستخدمين. قد نكشف عن المعلومات الشخصية للرد على المتطلبات القانونية ، أو فرض سياساتنا ، أو الرد على
                الادعاءات التي تفيد بأن نشرًا أو محتوى آخر ينتهك حقوق الآخرين ، أو لحماية حقوق أي شخص أو ممتلكاته أو
                سلامته.
            </p>
            <br>
            <h5>الأمان</h5>
            <p>
                نحن نستخدم الكثير من الأدوات (التشفير ، وكلمات المرور ، والأمن المادي) لحماية معلوماتك الشخصية من الوصول
                غير المصرح به والكشف عنها. ستحافظ الخدمة على خصوصية جميع التفاصيل الإلكترونية الشخصية باستثناء تلك التي
                ترغب في الكشف عنها. من غير المقبول الكشف عن معلومات الاتصال الخاصة بالآخرين من خلال الخدمة. إذا انتهكت
                قوانين دولة الإمارات العربية المتحدة و / أو شروط استخدام الخدمة ، فإنك بذلك تفقد حقوق الخصوصية الخاصة بك
