...
<body>
    ...
    <div class="modal fade base-modal" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="static">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header modal-header-general">
                    <h5 class="modal-title" id="exampleModalLongTitle">تسجيل الدخول</h5>
                    @if (LaravelLocalization::getLocalizedURL('en') != route('new.ads') && LaravelLocalization::getLocalizedURL('ar') != route('new.ads'))
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger new-account" data-toggle="modal" data-target="#exampleModalCenterAccount">تسجيل مستخدم جديد</button>
                </div>
            </div>
        </div>
    </div>
    <!-- Modal Login with email -->
    <div class="modal fade modal-email" id="exampleModalCenterEmail" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="static">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header modal-header-email">
                    <button type="button" class="left-arrow-email" data-dismiss="modal" aria-label="Close" data-toggle="modal" data-target="#exampleModalCenter">
                ...
                <div class="modal-body">
                    <form id="loginForm" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group">
                            <input type="email" class="form-control" placeholder="البريد الالكتروني " name="email" :value="old('email')" required autofocus>
                        </div>
                        <div class="form-group">
                            <input type="password" class="form-control" placeholder="كلمة السر" name="password" required autocomplete="current-password">
                        </div>
    ...
    <!-- Modal Rigester -->
    <div class="modal fade modal-account" id="exampleModalCenterAccount" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="static">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header modal-header-account">
                    <button type="button" class="left-arrow-account" data-dismiss="modal" aria-label="Close" data-toggle="modal" data-target="#exampleModalCenter">
                        <span aria-hidden="true">&rightarrow;</span>
                    </button>
                ...
                <div class="modal-body" id="modal-body">
                    <form id="registerForm" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            <input name="name" type="text" class="form-control" placeholder="الاسم" value="{{ old('name') }}">
                        </div>
                        <div class="form-group">
                            <input name="email" type="email" class="form-control" placeholder="البريد الالكتروني " value="{{ old('email') }}">
                        </div>
                        <div class="form-group">
                            <input name="password" type="password" class="form-control" placeholder="كلمة السر" required autocomplete="new-password">
                        </div>
                        <div class="form-group">
                            <input name="password_confirmation" type="password" class="form-control" placeholder="كلمة السر" required>
                        </div>
                        ...
                        <div class="form-group">
                            <select name="phonecode" id="phonecode" class="form-control">
                                ...
                                <option value="{{ $country->phonecode }}" {{ old('phonecode') == $country->phonecode ? 'selected' : '' }}>
                                    {{ $country->name }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            <input name="mobile" type="text" class="form-control" placeholder="رقم الهاتف 05xxxxxxxx" {{ old('mobile') }}>
                        </div>
                        <div class="form-group">
                            <select name="type_user" class="form-control">
                                <option disabled selected hidden>نوع المستخدم</option>
                                <option value="1" {{ old('type_user') == 1 ? 'selected' : '' }}>مستخدم عادي</option>
                                <option value="2" {{ old('type_user') == 2 ? 'selected' : '' }}>تاجر</option>
                                <option value="3" {{ old('type_user') == 3 ? 'selected' : '' }}>معرض سيارات</option>
                            </select>
                        </div>
    ...
    <div class="modal fade modal-account" id="showroomInformation" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header modal-header-account">
                    <button type="button" class="left-arrow-account" data-dismiss="modal" aria-label="Close" data-toggle="modal" data-target="#exampleModalCenter">
                ...
                <div class="modal-body" id="modal-body">
                    <form id="registerFormShowroom" method="Post" action="{{ route('showroom.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input name="image" id="logo" type="file" class="form-control" placeholder="صورة المعرض" required>
                        </div>
                        <div class="form-group">
                            <label for="logo1">شعار المعرض</label>
                            <input name="logo" id="logo1" type="file" class="form-control" placeholder="شعار المعرض" required>
                        </div>
