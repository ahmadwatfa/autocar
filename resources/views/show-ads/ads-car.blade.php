                    ...
                    <div class="ads-space">
                        <div class="space-head">
                            ...
                            <div class="tool">
                                ...
                                <a class="btn" href="https://www.facebook.com/sharer/sharer.php?u={{ url()->full() }}"
                                ...
                                <a class="btn"
                                    ...
                                    <!DOCTYPE svg
                                        PUBLIC '-//W3C//DTD SVG 1.1//EN' 'http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd'>
                                    <svg height="20" width="20" style="enable-background:new 0 0 512 512;"
                                ...
                                <button class="btn fav star" data-id="{{ $ads->id }}">{{ __('messages.fav') }}<span><i
                                            class="fa fa-heart star"></i></span></button>
                            </div>
                        </div>
