...
<div class="modal fade modal-account" id="ModalWorng" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
...
@guest
<!-- Modal -->
<div class="modal fade modal-account" id="adsFree" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document" style="display: flex;
        ...
        <div class="modal-content" style="width: 65%">
            ...
            <div class="modal-body" id="modal-body" style="margin: 0 auto;">
                ...
                <button href="" class="btn btn-danger new-ads" onclick="window.open('{{ route('new.ads') }}','_self')">أضف إعلانك مجانا على موقع أوتو
                    مارك</button>
            </div>
        </div>
    </div>
