...
@section('container')
    <div class="d-flex add-country">
        <a href="{{ route('addCompany') }}" class="btn btn-primary d-flex justify-content-between align-items-left">Add Country <span class="icon-plus-circle"></span></a>
    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="td-actions">
                                    <a href="{{route('editCountry', $company->id)}}" class="icon red" data-toggle="tooltip" data-placement="top"
                                        title="View Company">
