    ...
    <div class="container-fluid">
        ...
        <nav class="navbar navbar-expand-lg custom-navbar">
            ...
            <div class="collapse navbar-collapse" id="WafiAdminNavbar">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link active-page" href="{{ route('main') }}" id="dashboardsDropdown" role="button"
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="appsDropdown">
                            <li>
                                <a class="dropdown-item" href="{{ route('country') }}">Country & City</a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="{{ route('company') }}">Car Brand</a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="{{ route('list') }}">List</a>
                            </li>
                            {{-- <li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="pagesDropdown">
                            <li>
                                <a class="dropdown-item" href="{{ route('AdminAdsCar') }}">Ads Car</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
