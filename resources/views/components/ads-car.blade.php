                    ...
                    <a id="section_add" href="{{ route('ads-car.show', $ad->id) }}">
                        <div class="advert">
                            <div class="head">
                                ...
                                @if (app()->getLocale() == 'ar')
                                    <div class="title">
                                        <h6>{{ App\Models\Company::where('id', $ad->carComany_id)->first()->name_ar }} -
                                            {{ App\Models\ComModel::where('id', $ad->carModel_id)->first()->name_ar }}
                                        </h6>
                                    </div>
                                @else
                                    <div class="title">
                                        <h6>{{ App\Models\Company::where('id', $ad->carComany_id)->first()->name_en }} -
                                            {{ App\Models\ComModel::where('id', $ad->carModel_id)->first()->name_en }}
                                        </h6>
                                    </div>
                                @endif
