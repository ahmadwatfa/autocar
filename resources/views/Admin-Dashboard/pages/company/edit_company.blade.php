                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <input type="text" class="form-control" id="name-ar" name="name_ar"
                                                        placeholder="company Name Arabic" value="{{$company->name_ar}}" required="">
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" class="form-control" id="name-en" name="name_en"
                                                        placeholder="company Name English"  value="{{$company->name_en}}" required="">
                                                </div>
                                                <div class="form-group">
                                                    <select class="form-control" id="type" name="type" required="">
                                                        <option value="" disabled selected hidden>Choose the type of company</option>
                                                        <option @if ($company->type == 'car') selected  @endif value="car">Car</option>
                                                        <option  @if ($company->type == 'motorcycle') selected  @endif value="motorcycle">Motorcycle</option>
                                                    </select>
                                                </div>
                                                <div class="form-group">
