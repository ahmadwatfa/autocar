            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"> اضافة موديل <small>جديد</small> </h3>
                                        ...
                                        <div class="tab-pane active fade in" id="tab_1-1">
                                            <div class="card m-0">
                                                <div class="card-header">
                                                    ...
                                                    <input type="text" class="form-control" readonly placeholder="Country Name Arabic" required="" value="Add New Model To {{ $company->name_en }}">
