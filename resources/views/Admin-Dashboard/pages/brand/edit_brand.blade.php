            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"> تعديل موديل </h3>
                        <i class="pull-left header fa fa-th"></i>
                    </div><!-- /.box-header -->

                    <form action="{{ route('brand.update' , $car->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                                        ...
                                        <div class="tab-pane active fade in" id="tab_1-1">
                                            <div class="card m-0">
                                                <div class="card-header">
                                                    ...
                                                    {{-- <input type="text" class="form-control" readonly placeholder="Country Name Arabic" required="" value="Add New Model To {{ $car->company_id }}"> --}}
                                                ...
                                                <div class="card-body">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="name-ar" name="name_ar"
                                                            placeholder="Brand Name Arabic" required="" value="{{$car->name_ar}}">
                                                    </div>
                                                    <div class="form-group">
