            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"> اضافة مدينة <small>جديدة</small> </h3>
                                        ...
                                        <div class="tab-pane active fade in" id="tab_1-1">
                                            <div class="card m-0">
                                                {{-- <div class="card-header">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="name-ar" name="name_ar"
                                                            placeholder="City Name Arabic" readonly value="Add City to {{ $country->sortname }}">
                                                    </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="name-ar" name="name_ar"
                                                            placeholder="City Name Arabic" required="" value="{{$city->name_ar}}">
                                                    </div>
                                                    <div class="form-group">
