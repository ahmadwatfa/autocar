            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"> تعديل ثابت </h3>
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <input type="text" class="form-control" id="name-ar" name="name_ar"
                                                        placeholder="Item Name Arabic" value="{{$list->name_ar}}" >
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" class="form-control" id="name-en" name="name_en"
                                                        placeholder="Item Name English" required="" value="{{$list->name_en}}">
                                                </div>
                                                <div class="form-group">
                                                    <select name="list_type" id="list_type" class="form-control">
                                                        <option  @if($list->list_type == "None") selected @endif value="none">None</option>
                                                        <option @if($list->list_type == "specification_car") selected @endif value="specification_car">Specification Car</option>
                                                        <option @if($list->list_type == "status_car") selected @endif value="status_car">Status Car</option>
                                                        <option @if($list->list_type == "status_engine") selected @endif value="status_engine">Status Engine</option>
                                                        <option @if($list->list_type == "body_car") selected @endif value="body_car">Body Car</option>
                                                        <option @if($list->list_type == "number_door") selected @endif value="number_door">Number Door Car</option>
                                                        <option @if($list->list_type == "petrol_type") selected @endif value="petrol_type">Petrol Type</option>
                                                        <option @if($list->list_type == "color") selected @endif value="color">Color</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div><!-- /.tab-pane -->
