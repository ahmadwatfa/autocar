...
<head>
    ...
    <!-- Title -->
    <title>AutoMark DashBoard</title>
  ...
  ************ -->
    ...
    <link rel="stylesheet" href="{{ asset('assets/dashboard/vendor/chartist/css/chartist-custom.css') }}" />
...
<body>
    ...
    <header class="header">
        <div class="logo-wrapper">
            <a href="{{-- route('main') --}}" class="logo">
                <img src="{{ asset('images/logo.png') }}" alt="Wafi Admin Dashboard" />
            </a>
                        ...
                        <div class="header-profile-actions">
                            <div class="header-user-profile">
                                <div class="header-user">
                                    <img src="{{ asset('assets/dashboard/img/user.png') }}" alt="Admin Template" />
                                </div>
                                <h5>Zyan Ferris</h5>
                                <p>Admin</p>
                            </div>
    ...
    <div class="container-fluid">
        ...
        <nav class="navbar navbar-expand-lg custom-navbar">
            ...
            <div class="collapse navbar-collapse" id="WafiAdminNavbar">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link active-page" href="{{-- route('main') --}}" id="dashboardsDropdown"
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="appsDropdown">
                            <li>
                                <a class="dropdown-item" href="{{ route('country.index') }}">Country & City</a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="{{ route('company.index') }}">Company & Brand</a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="{{ route('lists.index') }}">List</a>
                            </li>
                            {{-- <li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="pagesDropdown">
                            <li>
                                <a class="dropdown-item" href="{{ route('Admin.AdsCar') }}">Ads Car</a>
                            </li>
                        </ul>
                    </li>
                    {{-- <li class="nav-item dropdown">
        ...
        <!-- Footer start -->
        <footer class="main-footer">© AutoMark {{ date('Y') }}</footer>
        <!-- Footer end -->
    ...
    <!-- Chartist JS -->
    <script src="{{ asset('assets/dashboard/vendor/chartist/js/chartist.min.js') }}"></script>
    <script src="{{ asset('assets/dashboard/vendor/chartist/js/chartist-tooltip.js') }}"></script>
    <script src="{{ asset('assets/dashboard/vendor/chartist/js/custom/threshold/threshold.js') }}"></script>
    <script src="{{ asset('assets/dashboard/vendor/chartist/js/custom/bar/bar-chart-orders.js') }}"></script>

    <!-- jVector Maps -->
    <script src="{{ asset('assets/dashboard/vendor/jvectormap/jquery-jvectormap-2.0.3.min.js') }}"></script>
    <script src="{{ asset('assets/dashboard/vendor/jvectormap/world-mill-en.js') }}"></script>
    <script src="{{ asset('assets/dashboard/vendor/jvectormap/gdp-data.js') }}"></script>
    <script src="{{ asset('assets/dashboard/vendor/jvectormap/custom/world-map-markers2.js') }}"></script>

    <!-- Rating JS -->
    <script src="{{ asset('assets/dashboard/vendor/rating/raty.js') }}"></script>
    <script src="{{ asset('assets/dashboard/vendor/rating/raty-custom.js') }}"></script>
