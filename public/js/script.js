    ...
    var e = function (e, n) {
        var n = n || t(e.imageBox),
            i = {
                ...
                getBlob: function () {
                    for (
                        var t = this.getDataURL(),
                            e = t.replace("data:image/png;base64,", ""),
                            n = atob(e),
                            i = [],
                            a = 0;
                        a < n.length;
                    ...
                    return new Blob([new Uint8Array(i)], { type: "image/png" });
                },
                zoomIn: function () {
                    (this.ratio *= 1.1), a();
                },
            ...
            o = function (t) {
                t.stopImmediatePropagation(),
                    (i.state.dragable = !0),
                    (i.state.mouseX = t.clientX),
                    (i.state.mouseY = t.clientY);
            },
            s = function (t) {
                if ((t.stopImmediatePropagation(), i.state.dragable)) {
                    var e = t.clientX - i.state.mouseX,
                        ...
                        s = e + parseInt(o[0]),
                        r = a + parseInt(o[1]);
                    n.css("background-position", s + "px " + r + "px"),
                        (i.state.mouseX = t.clientX),
                        (i.state.mouseY = t.clientY);
                }
            },
            ...
            u = function (t) {
                (i.ratio *=
                    t.originalEvent.wheelDelta > 0 || t.originalEvent.detail < 0
                        ? 1.1
                        : 0.9),
                    a();
            };
        return (
            ...
            (i.image.onload = function () {
                i.spinner.hide(),
                    ...
                    n.bind("mousedown", o),
                    n.bind("mousemove", s),
                    t(window).bind("mouseup", r),
                    n.bind("mousewheel DOMMouseScroll", u);
            }),
            (i.image.src = e.imgSrc),
...
$(window).load(function () {
    ...
    $("#range_zoom").on("input", function () {
        if ($(this).val() > num) cropper.zoomIn();
        else cropper.zoomOut();
        num = $(this).val();
    });
