...
!(function (e) {
    ...
    (e.fn.fileinputLocales = {}),
        ...
        e.fn.fileinputBsVersion || (e.fn.fileinputBsVersion = (window.bootstrap && window.bootstrap.Alert && window.bootstrap.Alert.VERSION) || (window.Alert && window.Alert.VERSION) || "3.x.x"),
    ...
    (t = {
        ...
        isIE: function (e) {
            ...
            return "Microsoft Internet Explorer" !== navigator.appName
                ...
                : ((t = document.createElement("div")), (t.innerHTML = "<!--[if IE " + e + "]> <i></i> <![endif]-->"), (i = t.getElementsByTagName("i").length), document.body.appendChild(t), t.parentNode.removeChild(t), i);
        },
        ...
        toggleFullScreen: function (e) {
            ...
            a && e && !r
                ...
                : r && (i.exitFullscreen ? i.exitFullscreen() : i.msExitFullscreen ? i.msExitFullscreen() : i.mozCancelFullScreen ? i.mozCancelFullScreen() : i.webkitExitFullscreen && i.webkitExitFullscreen());
        },
        ...
        whenAll: function (i) {
            ...
            for (
                ...
                (r = c[a]) && e.isFunction(r.promise) ? r.promise().done(l(a, s, c)).fail(l(a, n, o)) : (u.notifyWith(this, r), --m);
        ...
        (i.prototype = {
                                        ...
                                        n = function (t) {
                                            ...
                                            o = function () {
                                                ...
                                                return (
                                                    ...
                                                    c.push(e),
                                                    r.cancelled
                                                        ? (u.reject.apply(null, c), void r.cancelledDeferrer.resolve())
                                                        : (c.length === r.size() && (l ? u.reject.apply(null, c) : u.resolve.apply(null, c)), void (d.length && ((a = d.shift()), n(a), a.run())))
                                                );
                                            };
                                        d.length && s++ < i;
            ...
            _init: function (i, a) {
                ...
                (l.options = i),
                    ...
                    void 0 === l.errorCloseButton && (l.errorCloseButton = t.closeButton("kv-error-close" + (t.isBs(5) ? "  float-end" : ""))),
                    l.maxTotalFileCount > 0 && l.maxTotalFileCount < l.maxFileCount && (l.maxTotalFileCount = l.maxFileCount),
                    l.rtl && ((s = l.previewZoomButtonIcons.prev), (l.previewZoomButtonIcons.prev = l.previewZoomButtonIcons.next), (l.previewZoomButtonIcons.next = s)),
                    !isNaN(l.maxAjaxThreads) && l.maxAjaxThreads < l.resumableUploadOptions.maxThreads && (l.resumableUploadOptions.maxThreads = l.maxAjaxThreads),
                    l._initFileManager(),
                    ...
                    (l.progressPauseTemplate = o.replace("{class}", l.progressPauseClass)),
                    (l.progressCompleteTemplate = o.replace("{class}", l.progressCompleteClass)),
                    (l.progressErrorTemplate = o.replace("{class}", l.progressErrorClass)),
                    (l.isDisabled = d.attr("disabled") || d.attr("readonly")),
                    l.isDisabled && d.attr("disabled", !0),
                    (l.isClickable = l.browseOnZoneClick && l.showPreview && (l.dropZoneEnabled || !t.isEmpty(l.defaultPreviewContent))),
                    ...
                    !l.imageCanvas && l.resizeImage && (l.maxImageWidth || l.maxImageHeight) && ((l.imageCanvas = document.createElement("canvas")), (l.imageCanvasContext = l.imageCanvas.getContext("2d"))),
                    ...
                    (l.$captionContainer = t.getElement(i, "elCaptionContainer", n.find(".file-caption"))),
                    (l.$caption = t.getElement(i, "elCaptionText", n.find(".file-caption-name"))),
                    t.isEmpty(l.msgPlaceholder) || ((r = d.attr("multiple") ? l.filePlural : l.fileSingle), l.$caption.attr("placeholder", l.msgPlaceholder.replace("{files}", r))),
                    (l.$captionIcon = l.$captionContainer.find(".file-caption-icon")),
                    (l.$previewContainer = t.getElement(i, "elPreviewContainer", n.find(".file-preview"))),
                    (l.$preview = t.getElement(i, "elPreviewImage", n.find(".file-preview-thumbnails"))),
                    (l.$previewStatus = t.getElement(i, "elPreviewStatus", n.find(".file-preview-status"))),
                ...
                (i.uploadStartTime = t.now()),
                    (i.fileManager = {
                        ...
                        getUploadStats: function (e, a, r) {
                            var n,
                                o = i.fileManager,
                                s = e ? (o.stats[e] && o.stats[e].started) || t.now() : i.uploadStartTime,
                                l = (t.now() - s) / 1e3,
                                d = Math.ceil(l ? a / l : 0),
                                c = r - a,
                            ...
                            return (
                                ...
                                (n = { fileId: e, started: s, elapsed: l, loaded: a, total: r, bps: o.bps, bitrate: i._getSize(o.bps, i.bitRateUnits), pendingBytes: c }),
                        ...
                        add: function (e, a) {
                            a || (a = i.fileManager.getId(e)),
                                a && (i.fileManager.stack[a] = { file: e, name: t.getFileName(e), relativePath: t.getFileRelativePath(e), size: e.size, nameFmt: i._getFileName(e, ""), sizeFmt: i._getSize(e.size) });
                        },
                        remove: function (e) {
                    ...
                    (i = a.resumableManager = {
                        init: function (e, t, n) {
                            (i.logs = []),
                                ...
                                a.showPreview &&
                                    ...
                                    i.$thumb && i.$thumb.length && ((i.$progress = i.$thumb.find(".file-thumb-progress")), (i.$btnDelete = i.$thumb.find(".kv-file-remove")))),
                                (i.chunkSize = r.chunkSize * a.bytesToKB),
                                (i.chunkCount = i.getTotalChunks());
                        },
                        setAjaxError: function (e, t, o, s) {
                            e.responseJSON && e.responseJSON.error && (o = e.responseJSON.error.toString()), s || (i.error = o), r.showErrorLog && a._log(n.ajaxError, { status: e.status, error: o, text: e.responseText || "" });
                        },
                        reset: function () {
                            ...
                            (i.completed = !0),
                                ...
                                "success" === t
                                    ? ((o.uploadedSize += i.file.size),
                                      a.showPreview && (a._setProgress(101, c), a._setThumbStatus(d, "Success"), a._initUploadSuccess(i.chunksProcessed[l].data, d)),
                                      o.removeFile(l),
                                      delete i.chunksProcessed[l],
                                      a._raise("fileuploaded", [p.id, p.index, p.fileId]),
                                      o.isProcessed() && a._setProgress(101))
                                    : "cancel" !== t &&
                                      (a.showPreview && (a._setThumbStatus(d, "Error"), a._setPreviewError(d, !0), a._setProgress(101, c, a.msgProgressError), a._setProgress(101, a.$progress, a.msgProgressError), (a.cancelling = !f)),
                                      a.$errorContainer.find('li[data-file-id="' + p.fileId + '"]').length ||
                                          ((s = { file: i.fileName, max: r.maxRetries, error: i.error }),
                                          (n = a.msgResumableUploadRetriesExceeded.setTokens(s)),
                                          e.extend(p, s),
                                          a._showFileError(n, p, "filemaxretries"),
                                          f && (o.removeFile(l), delete i.chunksProcessed[l], o.isProcessed() && a._setProgress(101)))),
                        ...
                        upload: function () {
                            ...
                            e = setInterval(function () {
                                ...
                                if (
                                    (i.checkAborted(e),
                                    "new" === n && (a.lock(), (n = "processing"), (s = r.shift()), o.initStats(s), o.stack[s] && (i.init(s, o.stack[s], o.getIndex(s)), i.processUpload())),
                                    ...
                                    l.length && (t.addCss(l, t.SORT_CSS), a._initSortable()),
                                        ...
                                        setTimeout(function () {
                                            ...
                                            e && ((a.initialPreview = e.content), (a.initialPreviewConfig = e.config), (a.initialPreviewThumbTags = e.tags)),
                                                a._raise("filebatchuploadcomplete", [a.initialPreview, a.initialPreviewConfig, a.initialPreviewThumbTags, a._getExtraData()]);
                                        }, a.processDelay);
                                }
                            }, a.processDelay);
                        },
                        ...
                        processUpload: function () {
                            ...
                            return r.testUrl
                                ? ((n = new FormData()),
                                  (s = o.stack[f]),
                                  a._setUploadData(n, { fileId: f, fileName: s.fileName, fileSize: s.size, fileRelativePath: s.relativePath, chunkSize: i.chunkSize, chunkCount: i.chunkCount }),
                                  (l = function (e) {
                                ...
                                (v = new FormData()),
                                    ...
                                    (_ = function (t, d, c) {
                                        ...
                                        var p = a.uploadParamNames,
                                            ...
                                            g = [u, e, s, o, i, w];
                                        t.error
                                            ? (r.showErrorLog && a._log(n.retryStatus, { retry: s + 1, filename: i.fileName, chunk: e }), a._raise("filechunkerror", g), i.pushAjax(e, s + 1), (i.error = t.error), h(t.error))
                                            : ((i.logs[t[f]] = !0),
                                              i.chunksProcessed[u] || (i.chunksProcessed[u] = {}),
                                              (i.chunksProcessed[u][t[f]] = !0),
                                              (i.chunksProcessed[u].data = t),
                                              l.resolve.call(null, t),
                                              a._raise("filechunksuccess", g),
                                              i.check());
                                    }),
                                    (C = function (t, r, n) {
                                        return a._isAborted()
                                            ? void h(m.resumableAborting)
                                            : ((w = a._getOutData(v, t)), i.setAjaxError(t, r, n), a._raise("filechunkajaxerror", [u, e, s, o, i, w]), i.pushAjax(e, s + 1), void h(m.resumableRetryError, { n: s - 1 }));
                                    }),
                                    (x = function () {
            ...
            _initTemplateDefaults: function () {
                ...
                (i =
                    ...
                    (s = '<input readonly class="file-caption-name form-control {class}">\n'),
                    (l = '<button type="{type}" title="{title}" class="{css}" {status} {tabIndexConfig}>{icon} {label}</button>'),
                    (d = '<a href="{href}" title="{title}" class="{css}" {status} {tabIndexConfig}>{icon} {label}</a>'),
                    (c = '<div class="{css}" {status} {tabIndexConfig}>{icon} {label}</div>'),
                    (Z = t.MODAL_ID + "Label"),
                    (u = '<div id="' + t.MODAL_ID + '" class="file-zoom-dialog modal fade" aria-labelledby="' + Z + '" {tabIndexConfig}></div>'),
                    (p =
                    ...
                    (H = '<button type="button" class="kv-desc-hide" aria-label="Close">{closeIcon}</button>'),
                    (f = '<div class="progress">\n    <div class="{class}" role="progressbar" aria-valuenow="{percent}" aria-valuemin="0" aria-valuemax="100" style="width:{percent}%;">\n        {status}\n     </div>\n</div>{stats}'),
                    (N = '<div class="text-primary file-upload-stats"><span class="pending-time">{pendingTime}</span> <span class="upload-speed">{uploadSpeed}</span></div>'),
                    ...
                    (b = '<a class="kv-file-download {downloadClass}" title="{downloadTitle}" href="{downloadUrl}" download="{caption}" target="_blank">{downloadIcon}</a>'),
                    (_ = '<button type="button" id="{previewId}" class="kv-file-zoom {zoomClass}" title="{zoomTitle}">{zoomIcon}</button>'),
                    (C = '<span class="file-drag-handle {dragClass}" title="{dragTitle}">{dragIcon}</span>'),
                    (x = '<div class="file-upload-indicator" title="{indicatorTitle}">{indicator}</div>'),
                    (y = '<div class="file-preview-frame {frameClass}" id="{previewId}" data-fileindex="{fileindex}" data-fileid="{fileid}" data-template="{template}" data-zoom="{zoomData}" onclick="selectMain(this.id, this.getAttribute(' + "'data-fileindex'" + '))"'),
                    ...
                    (E = '<img src="{data}" class="file-preview-image kv-preview-data" title="{title}" alt="{alt}"' + B + ">\n"),
                    (A = '<iframe class="kv-preview-data file-preview-office" src="https://view.officeapps.live.com/op/embed.aspx?src={data}"' + B + "></iframe>"),
                    (D = '<iframe class="kv-preview-data file-preview-gdocs" src="https://docs.google.com/gview?url={data}&embedded=true"' + B + "></iframe>"),
                    (z = '<video class="kv-preview-data file-preview-video" controls' + B + '>\n<source src="{data}" type="{type}">\n' + t.DEFAULT_PREVIEW + "\n</video>\n"),
                    ...
                    W._isPdfRendered() && (M = W.pdfRendererTemplate.replace("{renderer}", W._encodeURI(W.pdfRendererUrl))),
                    (W.defaults = {
                        layoutTemplates: {
                            main1: i,
                            main2: a,
                        ...
                        previewContentTemplates: { generic: F, html: S, image: E, text: I, office: A, gdocs: D, video: z, audio: $, flash: j, object: U, pdf: M, other: R },
                        ...
                        fileActionSettings: {
                            ...
                            dragSettings: {},
                            indicatorNew: '<i class="bi-check-circle text-warning removeSelected"></i>',
                            ...
                            indicatorNewTitle: "Select Main Image",
                ...
                (i.previewCache = {
                    ...
                    get: function (e, a) {
                        var r,
                            ...
                            f = p.config[e],
                            m = p.content[e],
                            g = t.ifSet("previewAsData", f, i.initialPreviewAsData),
                        ...
                        return m && m.length
                            ? ((a = void 0 === a ? !0 : a),
                              ...
                              (r = g ? v(o, m, l, d, s, u, c) : v("generic", m, l, d, s, u, c, o).setTokens({ content: p.content[e] })),
                              p.tags.length && p.tags[e] && (r = t.replaceTags(r, p.tags[e])),
                              t.isEmpty(f) || t.isEmpty(f.frameAttr) || ((n = t.createElement(r)), n.find(".file-preview-initial").attr(f.frameAttr), (r = n.html()), n.remove()),
                              r)
                            : "";
                    },
                    clean: function (e) {
                    ...
                    add: function (e, a, r, n) {
                        ...
                        return e && e.length
                            ? ((o = e.length - 1),
                              ...
                              n && s.content ? ((o = s.content.push(e[0]) - 1), (s.config[o] = a), (s.tags[o] = r)) : ((s.content = e), (s.config = a), (s.tags = r)),
                    ...
                    unset: function (a) {
                        ...
                        if (r) {
                            if (1 === r)
                                return (i.previewCache.data.content = []), (i.previewCache.data.config = []), (i.previewCache.data.tags = []), (i.initialPreview = []), (i.initialPreviewConfig = []), void (i.initialPreviewThumbTags = []);
                            (i.previewCache.data.content = t.spliceArray(i.previewCache.data.content, a, n)),
                                (i.previewCache.data.config = t.spliceArray(i.previewCache.data.config, a, n)),
                                (i.previewCache.data.tags = t.spliceArray(i.previewCache.data.tags, a, n));
                    ...
                    footer: function (e, a, r) {
                        ...
                        var o,
                            ...
                            y = c === !1 && a;
                        return (
                            (_ = _ && s.downloadUrl !== !1 && !!h),
                            (o = i._renderFileActions(s, !1, _, b, C, x, y, c, u, !0, h, v)),
                            i._getLayoutTemplate("footer").setTokens({ progress: i._renderThumbProgress(), actions: o, caption: l, size: i._getSize(r), width: d, indicator: "" })
                        );
                    },
                }),
                    i.previewCache.init();
            ...
            _log: function (e, t) {
                var i = this,
                    a = i.$element.attr("id");
                i.showConsoleLogs &&
                    (a && (e = '"' + a + '": ' + e), (e = "bootstrap-fileinput: " + e), "object" == typeof t && (e = e.setTokens(t)), window.console && "undefined" != typeof window.console.log ? window.console.log(e) : window.alert(e));
            },
            _validate: function () {
                var e = this,
            ...
            _noFilesError: function (e) {
                var t = this,
                    ...
                    r = t.$errorContainer;
                (a = "<li>" + a + "</li>"),
                    0 === r.find("ul").length ? t._addError("<ul>" + a + "</ul>") : r.find("ul").append(a),
                    (t.isError = !0),
            ...
            _parseError: function (t, i, a, r) {
                var n,
                    ...
                    d = e.trim(a + "");
                return (
                    (o = i.responseJSON && i.responseJSON.error ? i.responseJSON.error.toString() : ""),
                    (s = o ? o : i.responseText),
                    l.cancelling && l.msgUploadAborted && (d = l.msgUploadAborted),
                    l.showAjaxErrorDetails && s && (o ? (d = e.trim(o + "")) : ((s = e.trim(s.replace(/\n\s*\n/g, "\n"))), (n = s.length ? "<pre>" + s + "</pre>" : ""), (d += d ? n : s))),
            ...
            _zoneDragEnter: function (i) {
                ...
                return (
                    ...
                    a.isDisabled || !n
                        ...
                        : ((r.dropEffect = "copy"), void (a._raise("fileDragEnter", { sourceEvent: i, files: r.types.Files }) && t.addCss(a.$dropZone, "file-highlighted")))
                );
            },
            ...
            _zoneDrop: function (e) {
                ...
                if ((e.preventDefault(), !a.isDisabled && !t.isEmpty(n) && a._raise("fileDragDrop", { sourceEvent: e, files: n })))
                    if (s > 0) {
                    ...
                    (i = {
                        ...
                        onSort: function (i) {
                            ...
                            d && (n = l - 1),
                                ...
                                (o.initialPreviewConfig = t.moveArray(o.initialPreviewConfig, r, n, u)),
                                o.previewCache.init(),
                                ...
                                o._raise("filesorted", { previewId: c.attr("id"), oldIndex: r, newIndex: n, stack: o.initialPreviewConfig });
                        },
                    }),
                ...
                (t.autoOrientImageInitial || a) &&
                    t.getFrames(".file-preview-initial").each(function () {
                        ...
                        l &&
                            ...
                            a ? r.css("image-orientation", t.autoOrientImageInitial ? "from-image" : "none") : t.setImageOrientation(r, n, l.exif.Orientation, s)),
                            i++;
                    });
            },
            ...
            _getZoomButton: function (e) {
                ...
                return (
                    ("fullscreen" !== e && "borderless" !== e && "toggleheader" !== e) || (s += ' data-toggle="button" aria-pressed="false" autocomplete="off"'),
                    '<button type="button" class="' + r + " btn-kv-" + e + '"' + s + ">" + a + "</button>"
                );
            },
            ...
            _listenModalEvent: function (e) {
                ...
                a.on(e + ".bs.modal", function (n) {
                    if ("bs.modal" === n.namespace) {
                        ...
                        a.data("fileinputPluginId") === i.$element.attr("id") && i._raise("filezoom" + e, r(n)),
                            "shown" === e &&
                                (s.removeClass("active").attr("aria-pressed", "false"),
                                o.removeClass("active").attr("aria-pressed", "false"),
                                a.hasClass("file-zoom-fullscreen") && (i._maximizeZoomDialog(), t.checkFullScreen() ? o.addClass("active").attr("aria-pressed", "true") : s.addClass("active").attr("aria-pressed", "true")));
                    }
                });
            },
            _initZoom: function () {
                ...
                (r = a._setTabIndex("modal", r)),
                    a.showPreview &&
                        ((a.$modal = e(n)),
                        (a.$modal && a.$modal.length) || ((i = t.createElement(t.cspBuffer.stash(r)).insertAfter(a.$container)), (a.$modal = e(n).insertBefore(i)), t.cspBuffer.apply(a.$modal), i.remove()),
                        t.initModal(a.$modal),
            ...
            _resizeZoomDialog: function (e) {
                ...
                if (a.hasClass("file-zoom-fullscreen"))
                    t.toggleFullScreen(!1),
                        e
                            ? r.hasClass("active") || (a.removeClass("file-zoom-fullscreen"), i._resizeZoomDialog(!0), n.hasClass("active") && n.removeClass("active").attr("aria-pressed", "false"))
                            : r.hasClass("active")
                            ? r.removeClass("active").attr("aria-pressed", "false")
                            : (a.removeClass("file-zoom-fullscreen"), i.$modal.find(".kv-zoom-body").css("height", i.zoomModalHeight));
                else {
            ...
            _setZoomContent: function (i, a) {
                var r,
                    ...
                    y = i.data("zoom");
                y && ((y = decodeURIComponent(y)), (g = w.html().replace(h.zoomPlaceholder, "").setTokens({ zoomData: y })), w.html(g), i.data("zoom", ""), w.attr("data-zoom", y)),
                    (n = w.attr("data-template") || "generic"),
                    (r = w.find(".kv-file-content")),
                    (o = r.length ? r.html() : ""),
                    (f = i.data("caption") || h.msgZoomModalHeading),
                    (m = i.data("size") || ""),
                    (u = i.data("description") || ""),
                    b.find(".kv-zoom-caption").attr("title", f).html(f),
                    b.find(".kv-zoom-size").html(m),
                    (p = b.find(".kv-zoom-description").hide()),
                    u &&
                        (h.showDescriptionClose && (u = h._getLayoutTemplate("descriptionClose").setTokens({ closeIcon: h.previewZoomButtonIcons.close }) + "</button>" + u),
                        p.show().html(u),
            ...
            _showModal: function (e) {
                ...
                e &&
                    ...
                    i._setZoomContent(e),
                    a.data({ backdrop: !1, fileinputPluginId: i.$element.attr("id") }),
                    a.find(".kv-zoom-body").css("height", i.zoomModalHeight),
                    a.modal("show"),
                    i._initZoomButtons());
            },
            ...
            _zoomSlideShow: function (t, i) {
                ...
                if ((s.reversePreviewOrder && (t = "prev" === t ? "next" : "prev"), !l.attr("disabled"))) {
                    ...
                    0 > o || o >= u || !c[o] || ((a = e(c[o])), a.length && s._setZoomContent(a, t), s._initZoomButtons(), s._raise("filezoom" + t, { previewId: i, modal: s.$modal }));
                }
            },
            ...
            _refreshPreview: function () {
                ...
                (i._inputFileCount() || i.isAjaxUpload) &&
                    i.showPreview &&
                    i.isPreviewable &&
                    (i.isAjaxUpload && i.fileManager.count() > 0 ? ((t = e.extend(!0, {}, i.getFileList())), i.fileManager.clear(), i._clearFileInput()) : (t = i.$element[0].files),
            ...
            _clearFileInput: function () {
                var t,
                    ...
                    n = r.$element;
                r._inputFileCount() &&
                    ((t = n.closest("form")), (i = e(document.createElement("form"))), (a = e(document.createElement("div"))), n.before(a), t.length ? t.after(i) : a.after(i), i.append(n).trigger("reset"), a.before(n).remove(), i.remove());
            },
            _resetUpload: function () {
                ...
                (e.uploadStartTime = t.now()),
                    ...
                    e._resetCanvas(),
                    e.overwriteInitial && ((e.initialPreview = []), (e.initialPreviewConfig = []), (e.initialPreviewThumbTags = []), (e.previewCache.data = { content: [], config: [], tags: [] }));
            },
            ...
            _resetPreviewThumbs: function (e) {
                ...
                return e
                    ...
                    : void (i._hasInitialPreview() ? ((t = i.previewCache.out()), i._setPreviewContent(t.content), i._setInitThumbAttr(), i._setCaption(t.caption), i._initPreviewActions()) : i._clearPreview());
            },
            ...
            _getOutData: function (e, t, i, a) {
                var r = this;
                return (t = t || {}), (i = i || {}), (a = a || r.fileManager.list()), { formdata: e, files: a, filenames: r.filenames, filescount: r.getFilesCount(), extra: r._getExtraData(), response: i, reader: r.reader, jqXHR: t };
            },
            ...
            _ajaxSubmit: function (t, i, a, r, n, o, s, l) {
                ...
                f._raise("filepreajax", [n, o, s]) &&
                    ...
                    n.append("initialPreviewConfig", JSON.stringify(f.initialPreviewConfig)),
                    n.append("initialPreviewThumbTags", JSON.stringify(f.initialPreviewThumbTags)),
                    f._initAjaxSettings(),
            ...
            _initUploadSuccess: function (i, a, r) {
                ...
                return !m.showPreview || "object" != typeof i || e.isEmptyObject(i)
                    ...
                    : (void 0 !== i.initialPreview &&
                          ...
                          d.length > 0 && !t.isArray(d) && (d = d.split(m.initialPreviewDelimiter)),
                          d.length && (m._mergeArray("initialPreview", d), m._mergeArray("initialPreviewConfig", c), m._mergeArray("initialPreviewThumbTags", u)),
                          void 0 !== a
                              ? r
                                  ? ((p = a.attr("id")), (f = m._getUploadCacheIndex(p)), null !== f && (m.uploadCache[f] = { id: p, content: d[0], config: c[0] || [], tags: u[0] || [], append: n }))
                                  : ((s = m.previewCache.add(d[0], c[0], u[0], n)),
                              ...
                              : (m.previewCache.set(d, c, u, n), m._initPreview(), m._initPreviewActions())),
                      void m._resetCaption());
            },
            ...
            _uploadSingle: function (i, a, r) {
                ...
                w.enableResumableUpload ||
                    (w.showPreview && ((o = b.getThumb(a)), (u = o.find(".file-thumb-progress")), (l = o.find(".kv-file-upload")), (d = o.find(".kv-file-remove")), u.show()),
                    0 === _ ||
                        !y ||
                        (w.showPreview && l && l.hasClass("disabled")) ||
                        w._abort(k) ||
                        ((v = function () {
                            c ? b.errors.push(a) : b.removeFile(a), b.setProcessed(a), b.isProcessed() && ((w.fileBatchCompleted = !0), s());
                        }),
                        (s = function () {
                            var e;
                        ...
                        (p = function (s) {
                            (n = w._getOutData(C, s)),
                                ...
                                r || (w.ajaxAborted = !1),
                                w.showPreview && (o.hasClass("file-preview-success") || (w._setThumbStatus(o, "Loading"), t.addCss(o, "file-uploading")), l.attr("disabled", !0), d.attr("disabled", !0)),
                                r || w.lock(),
                                -1 !== b.errors.indexOf(a) && delete b.errors[a],
                                w._raise("filepreupload", [n, x, i, w._getThumbFileId(o)]),
                                e.extend(!0, k, n),
                                w._abort(k) && (s.abort(), r || (w._setThumbStatus(o, "New"), o.removeClass("file-uploading"), l.removeAttr("disabled"), d.removeAttr("disabled")), w._setProgressCancelled());
                        }),
                        (m = function (s, d, p) {
                            var m = w.showPreview && o.attr("id") ? o.attr("id") : x;
                            (n = w._getOutData(C, p, s)),
                                e.extend(!0, k, n),
                                setTimeout(function () {
                                    t.isEmpty(s) || t.isEmpty(s.error)
                                        ? (w.showPreview && (w._setThumbStatus(o, "Success"), l.hide(), w._initUploadSuccess(s, o, r), w._setProgress(101, u)),
                                          w._raise("fileuploaded", [n, m, i, w._getThumbFileId(o)]),
                                        ...
                                        : ((c = !0),
                                          ...
                                          r && v(),
                                          w._setProgress(101, w._getFrame(m).find(".file-thumb-progress"), w.msgUploadError));
                                }, w.processDelay);
                        }),
                        (g = function () {
                            w.showPreview && (l.removeAttr("disabled"), d.removeAttr("disabled"), o.removeClass("file-uploading")), r ? s() : (w.unlock(!1), w._clearFileInput()), w._initSuccessThumbs();
                        }),
                        (h = function (t, i, n) {
                            (f = w._parseError(T, t, n, w.fileManager.getFileName(a))),
                                ...
                                setTimeout(function () {
                                    ...
                                    r && v(),
                                        ...
                                        (i = w.showPreview && o ? o.find(".file-thumb-progress") : ""),
            ...
            _uploadBatch: function () {
                var i,
                    ...
                    f = new FormData(),
                    m = l.ajaxOperations.uploadBatch;
                if (0 !== c && p && !l._abort(u)) {
                    (s = function () {
                                      ...
                                      (c.each(function () {
                                          ...
                                          t.removeClass("file-uploading"),
                                              ...
                                              0 === u.length || -1 !== e.inArray(d, u)
                                                  ? (l._setPreviewError(t, !0), l.retryErrorUploads || (t.find(".kv-file-upload").hide(), l.fileManager.remove(t)))
                                                  : (t.find(".kv-file-upload").hide(), l._setThumbStatus(t, "Success"), l.fileManager.remove(t)),
                                              (t.hasClass("file-preview-error") && !l.retryErrorUploads) || d++;
                                      }),
                                      l._initUploadSuccess(i)),
                                  (o = l._parseError(m, r, l.msgUploadError)),
                        ...
                        (r = function (t, i, a) {
                            ...
                            (o = l._parseError(m, t, a)),
                                ...
                                l.showPreview &&
                                    ...
                                    l._setProgress(101, l.$progress, l.msgAjaxProgressError.replace("{operation}", m)));
                        });
                    var g = 0;
                ...
                (e = function (e) {
                    ...
                    (i = function (e, i, a) {
                        ...
                        t.isEmpty(e) || t.isEmpty(e.error)
                            ? (o._raise("filebatchuploadsuccess", [r]), o._clearFileInput(), o._initUploadSuccess(e), o._setProgress(101))
                            : ((n = o._parseError(d, a, o.msgUploadError)), o._showFileError(n, r, "filebatchuploaderror"));
                    }),
                    (a = function () {
                    ...
                    0 !== o || 0 !== n || l
                        ? ((t = n + o),
                          t > 1
                              ...
                              : 0 === o
                              ? ((a = e.initialPreviewConfig[0]), (r = ""), a && (r = a.caption || a.filename || ""), r || (r = e._getMsgSelected(t)))
                              : ((i = e.fileManager.getFirstFile()), (r = i ? i.nameFmt : "_")),
                          e._setCaption(r))
                        : e.reset();
                }, e.processDelay);
            },
                                    ...
                                    ? ((a = o.hasClass("file-preview-error")),
                                      ...
                                      void o.fadeOut("slow", function () {
                                          i.fileManager.remove(o),
                                              ...
                                              s &&
                                                  a &&
                                                  i.$errorContainer.find('li[data-thumb-id="' + s + '"]').fadeOut("fast", function () {
                            ...
                            (x = parseInt(x.replace(t.INIT_FLAG, ""))),
                                ...
                                (o = function (e, r, n) {
                                    ...
                                    return t.isEmpty(e) || t.isEmpty(e.error)
                                        ...
                                        : ((h.jqXHR = n),
                                          (h.response = e),
                                          (a = i._parseError(m, n, i.msgDeleteError, w)),
                                ...
                                (g = e.extend(!0, {}, { url: i._encodeURI(p), type: "POST", dataType: "json", data: e.extend(!0, {}, { key: f }, b) }, i._ajaxDeleteSettings)),
            ...
            _getSize: function (t, i) {
                ...
                return e.isNumeric(t) && e.isNumeric(o)
                    ? ("function" == typeof s ? (r = s(o)) : 0 === o ? (r = "0.00 B") : (i || (i = n.sizeUnits), (a = Math.floor(Math.log(o) / Math.log(n.bytesToKB))), (r = (o / Math.pow(n.bytesToKB, a)).toFixed(2) + " " + i[a])),
            ...
            _generatePreviewTemplate: function (i, a, r, n, o, s, l, d, c, u, p, f, m, g) {
                var h,
                    ...
                    P = _,
                    k = "type-default",
                    F = u || b._renderFileFooter(i, _, d, "auto", l),
                    S = b.preferIconicPreview,
                    E = b.preferIconicZoomPreview,
                    I = S ? "other" : i;
                return (
                    (v = 400 > y ? b.previewSettingsSmall[I] || b.defaults.previewSettingsSmall[I] : b.previewSettings[I] || b.defaults.previewSettings[I]),
                    v &&
                    ...
                    (w = function (a, l, d, u, g) {
                        var h,
                            v = d ? "zoom-" + o : o,
                            w = b._getPreviewTemplate(a),
                            C = (c || "") + " " + u;
                        return (
                            b.frameClass && (C = b.frameClass + " " + C),
                            d && (C = C.replace(" " + t.SORT_CSS, "")),
                            (w = b._parseFilePreviewIcon(w, r)),
                            "object" !== i ||
                                n ||
                                e.each(b.defaults.fileTypeSettings, function (e, t) {
                                    "object" !== e && "other" !== e && t(r, n) && (k = "type-" + e);
                                }),
                            t.isEmpty(m) || (void 0 !== m.title && null !== m.title && (T = m.title), void 0 !== m.alt && null !== m.alt && (T = m.alt)),
                            (h = {
                                previewId: v,
                                caption: _,
                                title: T,
                    ...
                    b.fileActionSettings.showZoom && (C = w(E ? "other" : i, a, !0, "kv-zoom-thumb", g)),
                    (C = "\n" + b._getLayoutTemplate("zoomCache").replace("{zoomContent}", C)),
                    "function" == typeof b.sanitizeZoomCache && (C = b.sanitizeZoomCache(C)),
                    (h = w(S ? "other" : i, a, !1, "kv-preview-thumb", g)),
            ...
            _setInitThumbAttr: function () {
                ...
                if (0 !== l)
                    for (var d = 0; l > d; d++)
                        (e = s.config[d]), (n = o.previewInitId + "-" + t.INIT_FLAG + d), (i = t.ifSet("caption", e, t.ifSet("filename", e))), (a = t.ifSet("size", e)), (r = t.ifSet("description", e)), o._setThumbAttr(n, i, a, r);
            },
            ...
            _updateFileDetails: function (e) {
                ...
                !d && s.fileManager.count() > 0 ? ((o = s.fileManager.getFirstFile()), (i = o.nameFmt)) : (i = d ? s.slug(d) : "_"),
                    (a = s.isAjaxUpload ? s.fileManager.count() : e),
                    (n = s.previewCache.count(!0) + a),
                    (r = 1 === a ? i : s._getMsgSelected(n, !s.isAjaxUpload && !s.isError)),
                    s.isError ? (s.$previewContainer.removeClass("file-thumb-loading"), s._initCapStatus(), s.$previewStatus.html(""), s.$captionContainer.removeClass("icon-visible")) : s._showFileIcon(),
            ...
            _setThumbStatus: function (e, i) {
                ...
                if (a.showPreview) {
                    ...
                    e.removeClass("file-preview-success file-preview-error file-preview-paused file-preview-loading"),
                        ...
                        s.attr("title", l[n]),
                        e.addClass(o),
                        "Error" !== i || a.retryErrorUploads || e.find(".kv-file-upload").attr("disabled", !0);
                }
            },
            ...
            _setProgress: function (e, i, a, r) {
                ...
                if (((i = i || n.$progress), i.length)) {
                    ...
                    e >= 100 && (r = ""),
                        t.isEmpty(c) ||
                            ((o = l && s > l && 100 >= e ? c.setTokens({ percent: l, status: n.msgUploadThreshold }) : c.setTokens({ percent: s, status: e > 100 ? n.msgUploadEnd : s + "%" })),
                            (r = r || ""),
            ...
            _setFileDropZoneTitle: function () {
                ...
                i.isClickable && ((e = t.isEmpty(i.$element.attr("multiple")) ? i.fileSingle : i.filePlural), (r += i.dropZoneClickTitle.replace("{files}", e))),
                    ...
                    !i.showPreview ||
                        ...
                        (0 === a.find(t.FRAMES).length && t.isEmpty(i.defaultPreviewContent) && a.prepend('<div class="' + i.dropZoneTitleClass + '">' + r + "</div>"),
            ...
            _getStats: function (e) {
                ...
                return r.showUploadStats && e && e.bitrate
                    ? ((a = r._getLayoutTemplate("stats")),
                      (i = e.elapsed && e.bps ? r.msgPendingTime.setTokens({ time: t.getElapsed(Math.ceil(e.pendingBytes / e.bps)) }) : r.msgCalculatingTime),
            ...
            _checkDimensions: function (e, i, a, r, n, o, s) {
                ...
                !t.isEmpty(m) &&
                    ...
                    (u = "Small" === i ? d >= m : m >= d),
                    u || ((l = p["msgImage" + o + i].setTokens({ name: n, size: m })), p._showFileError(l, s), p._setPreviewError(r)));
            },
                ...
                (c && u) ||
                    ...
                    f
                        ? ((i = a),
                          ...
                          (s = e(document.createElement("div")).appendTo(n.find(".kv-file-content"))),
                          (o = e(document.createElement("span")).insertBefore(i)),
                          i.css("visibility", "hidden").removeClass("file-zoom-detail").appendTo(s))
                        : (p = !i.is(":visible")),
                    i.off(l).on(l, function () {
                        ...
                        var e = i[0],
                            ...
                            u = e.offsetWidth,
                            m = t.getRotation(r);
                        if ((p && (n.find(".kv-file-content").css("visibility", "visible"), d.$preview.addClass("hide-content")), i.data("orientation", r), l && a.data("orientation", r), 5 > r))
                            return t.setTransform(e, m), void t.setTransform(l, m);
                        var g = Math.atan(u / c),
                            h = Math.sqrt(Math.pow(c, 2) + Math.pow(u, 2)),
                            v = h ? c / Math.cos(Math.PI / 2 + g) / h : 1,
                            w = " scale(" + Math.abs(v) + ")";
            ...
            _validateImageOrientation: function (i, a, r, n, o, s, l, d) {
                ...
                return (
                    (f = p._getExifObj(d)),
                    p.canOrientImage
                        ? (i.css("image-orientation", m ? "from-image" : "none"), void p._validateImage(r, n, o, s, l, d, f))
                        : ((u = t.getZoomSelector(r, " img")),
                          (c = f ? f["0th"][piexif.ImageIFD.Orientation] : null)
                              ? (p.setImageOrientation(i, e(u), c, p._getFrame(r)), p._raise("fileimageoriented", { $img: i, file: a }), void p._validateImage(r, n, o, s, l, d, f))
                    ...
                    m
                        .one("load", function () {
                            (l = p.width()),
                                ...
                                c._checkDimensions(f, "Small", m, p, i, "Width", s),
                                c._checkDimensions(f, "Small", m, p, i, "Height", s),
                                c.resizeImage || (c._checkDimensions(f, "Large", m, p, i, "Width", s), c._checkDimensions(f, "Large", m, p, i, "Height", s)),
                                c._raise("fileimageloaded", [e]),
                                c.fileManager.addImage(t, { ind: f, img: m, thumb: p, pid: e, typ: a, siz: r, validated: !1, imgData: n, exifObj: o }),
                                p.data("exif", o),
            ...
            _getResizedImage: function (i, a, r, n) {
                ...
                if (
                    ...
                    (m = { id: F, index: S, fileId: i }),
                    (g = [i, F, S]),
                    (!f || !y || (C >= w && x >= b)) && (y && f && h._raise("fileimageresized", g), r.val++, r.val === n && h._raise("fileimagesresized"), !y))
                )
                    return void c(h.msgImageResizeError, m, "fileimageresizeerror");
                (k = k || h.resizeDefaultImageType),
                    (s = w > C),
                    (l = b > x),
                    (_ = "width" === h.resizePreference ? (s ? C / w : l ? x / b : 1) : l ? x / b : s ? C / w : 1),
                    h._resetCanvas(),
                    (w *= _),
                    (b *= _),
                    (T.width = w),
                ...
                try {
                    P.drawImage(v, 0, 0, w, b),
                        ...
                        I && ((p = window.piexif.dump(I)), (d = window.piexif.insert(p, d))),
                        (o = t.dataURI2Blob(d)),
                        h.fileManager.setFile(i, o),
                        h._raise("fileimageresized", g),
                        r.val++,
                        r.val === n && h._raise("fileimagesresized", [void 0, void 0]),
                        o instanceof Blob || c(h.msgImageResizeError, m, "fileimageresizeerror");
                } catch (A) {
            ...
            _initClickable: function () {
                ...
                r.isClickable &&
                    ((i = r.$dropZone),
                    r.isAjaxUpload || ((a = r.$preview.find(".file-default-preview")), a.length && (i = a)),
                ...
                if (c.$caption.length) {
                    if ((c.$captionContainer.removeClass("icon-visible"), a))
                        (r = e("<div>" + c.msgValidationError + "</div>").text()),
                            ...
                            s ? ((d = c.fileManager.getFirstFile()), (l = 1 === s && d ? d.nameFmt : c._getMsgSelected(s))) : (l = c._getMsgSelected(c.msgNo)),
                            (n = t.isEmpty(i) ? l : i),
                            (o = '<span class="' + c.msgValidationErrorClass + '">' + c.msgValidationErrorIcon + "</span>");
                    else {
            ...
            _renderButton: function (e) {
                ...
                return (
                    ...
                    (r += "browse" === e ? " btn-file" : " fileinput-" + e + " fileinput-" + e + "-button"),
                    t.isEmpty(s) || (s = ' <span class="' + i.buttonLabelClass + '">' + s + "</span>"),
                    a.setTokens({ type: d, css: r, title: n, status: l, icon: o, label: s })
                );
            },
            _renderThumbProgress: function () {
                var e = this;
                return '<div class="file-thumb-progress kv-hidden">' + e.progressInfoTemplate.setTokens({ percent: 101, status: e.msgUploadBegin, stats: "" }) + "</div>";
            },
            _renderFileFooter: function (e, i, a, r, n) {
                var o,
                    ...
                    g = l._getLayoutTemplate("indicator"),
                ...
                return (
                    (a = l._getSize(a)),
                    (s = { type: e, caption: i, size: a, width: r, progress: "", indicator: w }),
                    l.isAjaxUpload ? ((s.progress = l._renderThumbProgress()), (s.actions = l._renderFileActions(s, p, !1, c, f, u, !1, !1, !1))) : (s.actions = l._renderFileActions(s, !1, !1, !1, f, u, !1, !1, !1)),
                    (o = m.setTokens(s)),
            ...
            _renderFileActions: function (e, t, i, a, r, n, o, s, l, d, c, u) {
                ...
                if (
                    ...
                    p.enableResumableUpload ? (t = !1) : "function" == typeof t && (t = t(e)),
                ...
                return (
                    a && (w = p._getLayoutTemplate("actionDelete").setTokens({ removeClass: T, removeIcon: x.removeIcon, removeTitle: x.removeTitle, dataUrl: m, dataKey: v, key: l })),
                    t && (b = p._getLayoutTemplate("actionUpload").setTokens({ uploadClass: x.uploadClass, uploadIcon: x.uploadIcon, uploadTitle: x.uploadTitle })),
                    i &&
                        ((_ = p._getLayoutTemplate("actionDownload").setTokens({ downloadClass: x.downloadClass, downloadIcon: x.downloadIcon, downloadTitle: x.downloadTitle, downloadUrl: c || p.initialPreviewDownloadUrl })),
                        (_ = _.setTokens({ filename: u, key: l }))),
                    r && (g = p._getLayoutTemplate("actionZoom").setTokens({ zoomClass: x.zoomClass, zoomIcon: x.zoomIcon, zoomTitle: x.zoomTitle })),
                    n && d && ((f = "drag-handle-init " + x.dragClass), (h = p._getLayoutTemplate("actionDrag").setTokens({ dragClass: f, dragTitle: x.dragTitle, dragIcon: x.dragIcon }))),
            ...
            _change: function (i) {
                ...
                if ((e(document.body).off("focusin.fileinput focusout.fileinput"), !a.changeTriggered)) {
                    ...
                    if (
                        ...
                        c || (u = i.target && void 0 === i.target.files ? (i.target.value ? [{ name: i.target.value.replace(/^.+\\/, "") }] : []) : i.target.files || {}),
                        (r = u),
            ...
            _abort: function (t) {
                var i,
                    a = this;
                return a.ajaxAborted && "object" == typeof a.ajaxAborted && void 0 !== a.ajaxAborted.message
            ...
            _canPreview: function (e) {
                ...
                var a,
                    ...
                    m = i.disabledPreviewTypes,
                    g = i.disabledPreviewMimeTypes,
                ...
                return (
                    ...
                    (o = (m && -1 !== m.indexOf(c)) || (g && -1 !== g.indexOf(l)) || (h.length && t.compare(s, b)) || (v && !isNaN(v) && d > v)),
                    !o && (a || r || n)
                );
            },
            ...
            clearFileStack: function () {
                ...
                return (
                    ...
                    e.enableResumableUpload ? (null === e.showPause && (e.showPause = !0), null === e.showCancel && (e.showCancel = !1)) : ((e.showPause = !1), null === e.showCancel && (e.showCancel = !0)),
                    e.$element
                );
            },
            ...
            _setLoading: function (e) {
                ...
                t.$previewStatus.html("hide" === e ? "" : t.msgProcessing),
                    ...
                    "hide" !== e && (t.dropZoneEnabled && t.$container.find(".file-drop-zone ." + t.dropZoneTitleClass).remove(), t.$container.addClass("file-thumb-loading"));
            },
            ...
            readFiles: function (i) {
                ...
                var a,
                    ...
                    h = t.isEmpty(g) ? "" : g.join(", "),
                    v = function (t, n, o, s, l) {
                        var d,
                            c = e.extend(!0, {}, r._getOutData(null, {}, {}, i), { id: o, index: s, fileId: l }),
                        ...
                        r._previewDefault(n, !0),
                            ...
                            r.isAjaxUpload
                                ...
                                : (r.unlock(), (u = 0)),
                            r.removeFromPreviewOnError && d.length ? d.remove() : (r._initFileActions(), d.find(".kv-file-upload").remove()),
                        ...
                        if (w >= u)
                            return (
                                ...
                                r.duplicateErrors.length &&
                                    ...
                                    0 === _.find("ul").length ? t.setHtml(_, r.errorCloseButton + "<ul>" + b + "</ul>") : _.find("ul").append(b),
                                    _.fadeIn(r.fadeDelay),
                                    r._handler(_.find(".kv-error-close"), "click", function () {
                                        _.fadeOut(r.fadeDelay);
                                    }),
                                    (r.duplicateErrors = [])),
                                r.isAjaxUpload ? (r._raise("filebatchselected", [C.stack]), 0 !== C.count() || r.isError || r.reset()) : r._raise("filebatchselected", [i]),
                        ...
                        var x,
                            ...
                            q = function () {
                                ...
                                setTimeout(function () {
                                    ...
                                    r._raise("fileloaded", [$, U, j, w, n]) && r.isAjaxUpload ? e || C.add($) : e && C.removeFile(j);
                            };
                        if ($) {
                            if (((E = C.getId($)), m > 0)) for (y = 0; m > y; y++) (F = f[y]), (S = r.msgFileTypes[F] || F), (Z += 0 === y ? S : ", " + S);
                            if (R === !1) return void a(w + 1);
                            if (0 === R.length) return (T = r.msgInvalidFileName.replace("{name}", t.htmlEncode(t.getFileName($), "[unknown]"))), void v(T, $, U, w, E);
                            if ((t.isEmpty(g) || (O = new RegExp("\\.(" + g.join("|") + ")$", "i")), (x = B.toFixed(2)), (r.isAjaxUpload && C.exists(E)) || r._getFrame(U, !0).length)) {
                                ...
                                return (
                                    ...
                                    void (r.isAjaxUpload
                                        ? (r.duplicateErrors.push(T), (r.isDuplicateError = !0), r._raise("fileduplicateerror", [$, E, R, x, U, w]), a(w + 1), r._updateFileDetails(u))
                                        : (r._showError(T, V), r.unlock(), (u = 0), r._clearFileInput(), r.reset(), r._updateFileDetails(u)))
                                );
                            }
                            if (r.maxFileSize > 0 && B > r.maxFileSize) return (T = r.msgSizeTooLarge.setTokens({ name: R, size: x, maxSize: r.maxFileSize })), void v(T, $, U, w, E);
                            if (null !== r.minFileSize && B <= t.getNum(r.minFileSize)) return (T = r.msgSizeTooSmall.setTokens({ name: R, size: x, minSize: r.minFileSize })), void v(T, $, U, w, E);
                            if (!t.isEmpty(f) && t.isArray(f)) {
                                for (y = 0; y < f.length; y += 1) (P = f[y]), (A = p[P]), (N += A && "function" == typeof A && A($.type, t.getFileName($)) ? 1 : 0);
                                if (0 === N) return (T = r.msgInvalidFileType.setTokens({ name: R, types: Z })), void v(T, $, U, w, E);
                            }
                            if (0 === N && !t.isEmpty(g) && t.isArray(g) && !t.isEmpty(O) && ((k = t.compare(R, O)), (N += t.isEmpty(k) ? 0 : k.length), 0 === N))
                                return (T = r.msgInvalidFileExtension.setTokens({ name: R, extensions: h })), void v(T, $, U, w, E);
                            if (!r._canPreview($))
                                return (
                                    (I = r.isAjaxUpload && r._raise("filebeforeload", [$, w, n])),
                                    r.isAjaxUpload && I && C.add($),
                                    r.showPreview && I && (o.addClass("file-thumb-loading"), r._initCapStatus("processing"), r._previewDefault($), r._initFileActions()),
                                    void setTimeout(function () {
                                        I && r._updateFileDetails(u), a(w + 1), r._raise("fileloaded", [$, U, j, w]);
                                    }, 10)
                                );
                            (D = M($.type, R)),
                                ...
                                (n.onload = function (i) {
                                    var a,
                                        ...
                                        g = function () {
                                            ...
                                            (e.onerror = function (e) {
                                                ...
                                                (e.onload = function (e) {
                                                    return r.isAjaxUpload && !r._raise("filebeforeload", [$, w, n])
                                                        ? ((H = !0), r._resetCaption(), n.abort(), s.html(""), o.removeClass("file-thumb-loading"), r._initCapStatus("valid"), void r.enable())
                                                        : (r._previewFile(w, $, e, L, l), r._initFileActions(), void q());
                                                }),
                                                e.readAsDataURL($);
                                        };
                                    if (
                                        ...
                                        e.each(p, function (e, t) {
                                            "object" !== e && "other" !== e && "function" == typeof t && t($.type, R) && W++;
                                        }),
                                        0 === W)
                                    ) {
                                        ...
                                        if (
                                            ...
                                            (f = t.getMimeType(a, "", "")),
                                            t.isEmpty(f) && ((u = t.arrayBuffer2String(n.result)), (f = t.isSvg(u) ? "image/svg+xml" : t.getMimeType(a, u, $.type))),
                                            (l = { name: R, type: f }),
                                            (D = M(f, "")))
                                        )
                                            return void g(z);
                                    ...
                                    return r.isAjaxUpload && !r._raise("filebeforeload", [$, w, n])
                                        ? ((H = !0), r._resetCaption(), n.abort(), s.html(""), o.removeClass("file-thumb-loading"), r._initCapStatus("valid"), void r.enable())
                                        : (r._previewFile(w, $, i, L, l), r._initFileActions(), void q());
                                }),
                                (n.onprogress = function (e) {
                                    if (e.lengthComputable) {
                                        var t = (e.loaded / e.total) * 100,
                                            i = Math.ceil(t);
                                        (T = d.setTokens({ index: w + 1, files: u, percent: i, name: R })),
                                            setTimeout(function () {
                                                H || s.html(T);
                                            }, r.processDelay);
                                    }
            ...
            resume: function () {
                ...
                return (
                    ...
                    e.enableResumableUpload
                        ? (e.paused ? e._toggleResumableProgress(e.progressPauseTemplate, e.msgUploadResume) : (i = !0),
                          (e.paused = !1),
                          i && e._toggleResumableProgress(e.progressInfoTemplate, e.msgUploadBegin),
                          setTimeout(function () {
                              a.upload();
                          }, e.processDelay),
                          e.$element)
                        ...
                        i._getThumbs().each(function () {
                            ...
                            a.removeClass("file-uploading"),
                                n.attr("title") === s.indicatorLoadingTitle &&
                                    (i._setThumbStatus(a, "Paused"), (t = r.setTokens({ pendingTime: i.msgPaused, uploadSpeed: "" })), (i.paused = !0), i._setProgress(o, a.find(".file-thumb-progress"), o + "%", t)),
                ...
                return (
                    i._getThumbs().each(function () {
                        ...
                        t.removeClass("file-uploading"),
                            i._setProgress(0, a),
                            a.hide(),
                            i._getThumbFile(t) || (t.find(".kv-file-upload").removeClass("disabled").removeAttr("disabled"), t.find(".kv-file-remove").removeClass("disabled").removeAttr("disabled")),
                            i.unlock();
                    }),
                    setTimeout(function () {
                        i._setProgressCancelled();
                ...
                if (a._raise("fileclear"))
                    return (
                        ...
                        a._hasInitialPreview()
                            ? (a._showFileIcon(), a._resetPreview(), a._initPreviewActions(), a.$container.removeClass("file-input-new"))
                            : (a._getThumbs().each(function () {
            ...
            disable: function () {
                ...
                return (
                    ...
                    i.find(".fileinput-remove, .fileinput-upload, .file-preview-frame button").attr("disabled", !0),
                    e._initDragDrop(),
                    e.$element
                );
            },
            enable: function () {
                ...
                return (
                    ...
                    t.find(".fileinput-remove, .fileinput-upload, .file-preview-frame button").removeAttr("disabled"),
            ...
            upload: function () {
                ...
                if (((n.bpsLog = []), (n.bps = 0), r.isAjaxUpload && !r.isDisabled && r._isFileSelectionValid(o))) {
                    if (((r.lastProgress = 0), r._resetUpload(), 0 === o && !s)) return void r._showFileError(r.msgUploadEmpty);
                ...
                switch (
                    ...
                    this.each(function () {
                        ...
                        l ||
                            ...
                            (o = e.extend(!0, {}, e.fn.fileinput.defaults, p, e.fn.fileinputLocales.en, u, d, s.data())),
                            (l = new i(this, o)),
                            s.data("fileinput", l)),
    ...
    (e.fn.fileinput.defaults = {
        ...
        previewZoomButtonClasses: { prev: "btn btn-default btn-outline-secondary btn-navigate", next: "btn btn-default btn-outline-secondary btn-navigate", toggleheader: r, fullscreen: r, borderless: r, close: r },
        previewTemplates: {},
        ...
        (e.fn.fileinputLocales.en = {
            ...
            msgFileTypes: { image: "image", html: "HTML", text: "text", video: "video", audio: "audio", flash: "flash", pdf: "PDF", object: "object" },
            ...
            ajaxOperations: { deleteThumb: "file delete", uploadThumb: "file upload", uploadBatch: "batch file upload", uploadExtra: "form data upload" },
